  ...
  return {
    ...
    defaults: {
      email: {
         ...
         *
         * @example function (emailAddress) {
         *  // Run `npm i mailchecker`
         *  const { isValid } = require('mailchecker');
        ...
        isValidEmail: (emailAddress) =>
          !Boolean(emailAddress.match(/@example\.com$/i)),
    ...
    initialize: function (done) {
      ...
      sails.after('hook:sendemail:loaded', function () {
        sails.helpers.email.send.configure({
          from: sails.configure.email.fromEmailAddress,
          fromName: sails.configure.email.fromName,
        });
      });
    },
  };
